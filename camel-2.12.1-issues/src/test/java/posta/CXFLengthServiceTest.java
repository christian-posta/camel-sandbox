 ...
 */
public class CXFLengthServiceTest extends CamelTestSupport{
    ...
    protected RouteBuilder createRouteBuilder() throws Exception {
        ...
        return new RouteBuilder() {
            ...
            public void configure() throws Exception {
                from("direct:start")
                .to("cxf:http://www.webservicex.net/length.asmx?" +
                        "wsdlURL=http://www.webservicex.net/length.asmx?WSDL" +
                        "&portName=lengthUnitSoap" +
                        "&dataFormat=PAYLOAD" +
